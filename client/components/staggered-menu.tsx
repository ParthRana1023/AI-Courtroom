  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full h-16 flex items-center justify-end px-4 bg-transparent pointer-events-none z-20"
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; height: 4rem; display: flex; align-items: center; justify-content: flex-end; padding: 0 1rem; background: transparent; pointer-events: none; z-index: 20; }
